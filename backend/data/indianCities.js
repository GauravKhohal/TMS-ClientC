// Major Indian cities with coordinates — used for city autocomplete + distance calculation
const indianCities = [
  // Maharashtra
  ...
  { name: 'Aurangabad',    state: 'Maharashtra',    lat: 19.8762, lng: 75.3433, aliases: ['Chhatrapati Sambhajinagar'] },
  ...
  // Karnataka
  { name: 'Bengaluru',     state: 'Karnataka',      lat: 12.9716, lng: 77.5946, aliases: ['Bangalore','Banglore','Bengalore'] },
  ...
  { name: 'Tirunelveli',   state: 'Tamil Nadu',     lat: 8.7139,  lng: 77.7567, aliases: ['Nellai'] },
  ...
  // Andhra Pradesh
  { name: 'Visakhapatnam', state: 'Andhra Pradesh', lat: 17.6868, lng: 83.2185, aliases: ['Vizag','Vishakhapatnam'] },
  ...
  // Rajasthan
  { name: 'Jaipur',        state: 'Rajasthan',      lat: 26.9124, lng: 75.7873, aliases: ['Pink City'] },
  { name: 'Jodhpur',       state: 'Rajasthan',      lat: 26.2389, lng: 73.0243 },
  { name: 'Udaipur',       state: 'Rajasthan',      lat: 24.5854, lng: 73.7125, aliases: ['Lake City'] },
  ...
  { name: 'Kollam',        state: 'Kerala',         lat: 8.8932,  lng: 76.6141, aliases: ['Quilon'] },
  ...
  { name: 'Margao',        state: 'Goa',            lat: 15.2832, lng: 73.9862, aliases: ['Madgaon'] },
  // North East
  ...
  // Other key logistics hubs
  { name: 'Pune',          state: 'Maharashtra',    lat: 18.5204, lng: 73.8567 },
  { name: 'Nhava Sheva',   state: 'Maharashtra',    lat: 18.9388, lng: 72.9499, aliases: ['JNPT','Jawaharlal Nehru Port'] },
  { name: 'Mundra',        state: 'Gujarat',        lat: 22.8385, lng: 69.7221 },
  { name: 'Kandla',        state: 'Gujarat',        lat: 23.0333, lng: 70.2167, aliases: ['Deendayal Port'] },
  { name: 'Haldia',        state: 'West Bengal',    lat: 22.0667, lng: 88.0833 },
  { name: 'Visakhapatnam Port', state: 'Andhra Pradesh', lat: 17.6947, lng: 83.2789, aliases: ['Vizag Port'] },
];
